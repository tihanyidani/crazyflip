...
"""autogenerated by genpy from pilot/SimulateActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class SimulateActionFeedback(genpy.Message):
  _md5sum = "a4a1bda97bbc7d22f782f62369a49039"
  _type = "pilot/SimulateActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pilot/SimulateFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SimulateActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = pilot.msg.SimulateFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pilot.msg.SimulateFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.progress_percentage
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.progress_percentage,) = _get_struct_B().unpack(str[start:end])
      return self
