...
"""autogenerated by genpy from crazyflie/PlanActionResult.msg. Do not edit."""
import codecs
import sys
...
class PlanActionResult(genpy.Message):
  ...
  _type = "crazyflie/PlanActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','crazyflie/PlanResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = crazyflie.msg.PlanResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = crazyflie.msg.PlanResult()
