...
"""autogenerated by genpy from simulator/PlanAction.msg. Do not edit."""
import codecs
import sys
...
class PlanAction(genpy.Message):
  _md5sum = "4a1eb94412cb801b177472d713d9e576"
  _type = "simulator/PlanAction"
...
"""
  ...
  _slot_types = ['simulator/PlanActionGoal','simulator/PlanActionResult','simulator/PlanActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = simulator.msg.PlanActionGoal()
      if self.action_result is None:
        self.action_result = simulator.msg.PlanActionResult()
      if self.action_feedback is None:
        self.action_feedback = simulator.msg.PlanActionFeedback()
    else:
      self.action_goal = simulator.msg.PlanActionGoal()
      self.action_result = simulator.msg.PlanActionResult()
      self.action_feedback = simulator.msg.PlanActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.command_list:
        _x = val1
        buff.write(_get_struct_2d().pack(_x.accel, _x.dd_roll))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = simulator.msg.Command()
        _x = val1
        start = end
        end += 16
        (_x.accel, _x.dd_roll,) = _get_struct_2d().unpack(str[start:end])
