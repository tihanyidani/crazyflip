...
"""autogenerated by genpy from simulator/PlanActionResult.msg. Do not edit."""
import codecs
import sys
...
class PlanActionResult(genpy.Message):
  ...
  _type = "simulator/PlanActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','simulator/PlanResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = simulator.msg.PlanResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = simulator.msg.PlanResult()
