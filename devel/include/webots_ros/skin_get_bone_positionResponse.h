...
bool operator==(const ::webots_ros::skin_get_bone_positionResponse_<ContainerAllocator1> & lhs, const ::webots_ros::skin_get_bone_positionResponse_<ContainerAllocator2> & rhs)
{
