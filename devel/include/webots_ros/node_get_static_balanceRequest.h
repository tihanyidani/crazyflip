...
bool operator==(const ::webots_ros::node_get_static_balanceRequest_<ContainerAllocator1> & lhs, const ::webots_ros::node_get_static_balanceRequest_<ContainerAllocator2> & rhs)
{
