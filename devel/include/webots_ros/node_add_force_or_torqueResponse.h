...
bool operator==(const ::webots_ros::node_add_force_or_torqueResponse_<ContainerAllocator1> & lhs, const ::webots_ros::node_add_force_or_torqueResponse_<ContainerAllocator2> & rhs)
{
