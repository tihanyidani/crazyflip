...
bool operator==(const ::webots_ros::node_get_orientationRequest_<ContainerAllocator1> & lhs, const ::webots_ros::node_get_orientationRequest_<ContainerAllocator2> & rhs)
{
