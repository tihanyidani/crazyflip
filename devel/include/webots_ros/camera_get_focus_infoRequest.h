...
bool operator==(const ::webots_ros::camera_get_focus_infoRequest_<ContainerAllocator1> & lhs, const ::webots_ros::camera_get_focus_infoRequest_<ContainerAllocator2> & rhs)
{
