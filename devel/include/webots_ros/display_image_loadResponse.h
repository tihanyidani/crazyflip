...
bool operator==(const ::webots_ros::display_image_loadResponse_<ContainerAllocator1> & lhs, const ::webots_ros::display_image_loadResponse_<ContainerAllocator2> & rhs)
{
