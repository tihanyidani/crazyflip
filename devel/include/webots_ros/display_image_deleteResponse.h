...
bool operator==(const ::webots_ros::display_image_deleteResponse_<ContainerAllocator1> & lhs, const ::webots_ros::display_image_deleteResponse_<ContainerAllocator2> & rhs)
{
