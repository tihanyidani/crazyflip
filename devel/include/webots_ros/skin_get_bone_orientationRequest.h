...
bool operator==(const ::webots_ros::skin_get_bone_orientationRequest_<ContainerAllocator1> & lhs, const ::webots_ros::skin_get_bone_orientationRequest_<ContainerAllocator2> & rhs)
{
