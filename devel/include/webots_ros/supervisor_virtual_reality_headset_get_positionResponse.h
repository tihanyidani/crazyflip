...
bool operator==(const ::webots_ros::supervisor_virtual_reality_headset_get_positionResponse_<ContainerAllocator1> & lhs, const ::webots_ros::supervisor_virtual_reality_headset_get_positionResponse_<ContainerAllocator2> & rhs)
{
