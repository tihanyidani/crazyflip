...
bool operator==(const ::webots_ros::range_finder_get_infoRequest_<ContainerAllocator1> & lhs, const ::webots_ros::range_finder_get_infoRequest_<ContainerAllocator2> & rhs)
{
