...
bool operator==(const ::webots_ros::lidar_get_layer_range_imageResponse_<ContainerAllocator1> & lhs, const ::webots_ros::lidar_get_layer_range_imageResponse_<ContainerAllocator2> & rhs)
{
