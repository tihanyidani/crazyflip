...
(cl:defmethod cl:initialize-instance :after ((m <PlanGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie-msg:<PlanGoal> is deprecated: use crazyflie-msg:PlanGoal instead.")))

(cl:ensure-generic-function 'interval_list-val :lambda-list '(m))
(cl:defmethod interval_list-val ((m <PlanGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie-msg:interval_list-val is deprecated.  Use crazyflie-msg:interval_list instead.")
  (interval_list m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PlanGoal>)))
  ...
  "10456e964d2e5406cf0e6a1df9aa5bd6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PlanGoal)))
  "Returns md5sum for a message object of type 'PlanGoal"
  "10456e964d2e5406cf0e6a1df9aa5bd6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PlanGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%float64[] interval_list~%crazyflie/Command[] command_list~%~%================================================================================~%MSG: crazyflie/Command~%float64 accel~%float64 roll~%float64 pitch~%float64 yaw~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PlanGoal)))
  "Returns full string definition for message of type 'PlanGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%float64[] interval_list~%crazyflie/Command[] command_list~%~%================================================================================~%MSG: crazyflie/Command~%float64 accel~%float64 roll~%float64 pitch~%float64 yaw~%~%"))
