...
(cl:defmethod cl:initialize-instance :after ((m <Measurement>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Measurement)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie-msg:<Measurement> is deprecated: use crazyflie-msg:Measurement instead.")))

(cl:ensure-generic-function 'stamp-val :lambda-list '(m))
(cl:defmethod stamp-val ((m <Measurement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie-msg:stamp-val is deprecated.  Use crazyflie-msg:stamp instead.")
  (stamp m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Measurement>)))
  ...
  (cl:format cl:nil "time stamp~%float64 x~%float64 y~%float64 z~%float64 roll~%float64 pitch~%float64 yaw~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Measurement)))
  "Returns full string definition for message of type 'Measurement"
  (cl:format cl:nil "time stamp~%float64 x~%float64 y~%float64 z~%float64 roll~%float64 pitch~%float64 yaw~%~%~%"))
