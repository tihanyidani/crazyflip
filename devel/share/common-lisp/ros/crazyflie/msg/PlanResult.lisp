...
(cl:defmethod cl:initialize-instance :after ((m <PlanResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie-msg:<PlanResult> is deprecated: use crazyflie-msg:PlanResult instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <PlanResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie-msg:success-val is deprecated.  Use crazyflie-msg:success instead.")
  (success m))
