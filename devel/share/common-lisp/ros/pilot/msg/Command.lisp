...
(cl:defmethod cl:initialize-instance :after ((m <Command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pilot-msg:<Command> is deprecated: use pilot-msg:Command instead.")))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pilot-msg:height-val is deprecated.  Use pilot-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'accel-val :lambda-list '(m))
(cl:defmethod accel-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pilot-msg:accel-val is deprecated.  Use pilot-msg:accel instead.")
  (accel m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Command>)))
  ...
  "63158adff50f896215247bc385d77c11")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Command)))
  "Returns md5sum for a message object of type 'Command"
  "63158adff50f896215247bc385d77c11")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Command>)))
  ...
  (cl:format cl:nil "float64 height~%float64 accel~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Command)))
  "Returns full string definition for message of type 'Command"
  (cl:format cl:nil "float64 height~%float64 accel~%~%"))
