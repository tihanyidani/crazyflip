...
class SimulateActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new SimulateFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SimulateFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SimulateActionFeedback(null);
    ...
    data.feedback = SimulateFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SimulateActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SimulateFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SimulateFeedback()
    }
...
module.exports = SimulateActionFeedback;
