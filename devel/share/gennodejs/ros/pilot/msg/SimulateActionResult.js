...
class SimulateActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new SimulateResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SimulateResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SimulateActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = SimulateResult.Resolve(msg.result)
    }
    else {
      resolved.result = new SimulateResult()
    }
...
module.exports = SimulateActionResult;
